...
import { TokenAmount, Token, ChainId, Percent, JSBI } from '@gravis.finance/sdk'
...
describe('utils', () => {
  describe('#getExplorerLink', () => {
    ...
    it('enum', () => {
      expect(getExplorerLink(ChainId.BSCTESTNET, 'abc', 'address')).toEqual('https://testnet.bscscan.com/address/abc')
    })
  })
