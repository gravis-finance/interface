...
describe('retry', () => {
  ...
  //   const error2 = new RetryableError();
  //   console.log('error 2', error2 instanceof Error);
  //   await expect(retry(makeFn(1, 'abc', false), { n: 3, maxWait: 0, minWait: 0 }).promise).resolves.toEqual('abc')
  // })
