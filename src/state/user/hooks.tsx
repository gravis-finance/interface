import { ChainId, Pair, Token } from '@gravis.finance/sdk'
...
export function useAddUserToken(): (token: Token | any) => void {
  const dispatch = useDispatch<AppDispatch>()
  return useCallback(
    (token: Token) => {
...
export function toV2LiquidityToken([tokenA, tokenB]: [Token, Token]): Token {
  return new Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB), 18, 'Gravis-LP', 'Gravis LPs')
}
