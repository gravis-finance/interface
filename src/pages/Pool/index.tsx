...
const UnlockButton = lazy(() => import('components/ConnectWalletButton'))
...
const ImportPoolCardBody = styled(CardBody)`
  padding: 6px 24px;
...
export default function Pool() {
  ...
  const getButton = () => {
    return (
      ...
      //   </Button>
      // ) : (
      <Button data-id="join-pool-button" as={Link} to="/add/ETH">
        {t('addLiquidity')}
      </Button>
      // )
    )
            ...
            {allV2PairsWithLiquidity?.length === 0 && (
              <>
                ...
                {!account ? (
                  ...
                  <Card>
                    <Body color="#909090" textAlign="center">
                      {t('liquidityNotFound')}
                    </Body>
                  </Card>
                )}
